    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ניהול כסף והשקעות - הדרך לחיות את החיים שתמיד רצית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '71ace4d7-c8ab-44d2-afc8-f6545e0565ea',
                    name: data.name || '',
                    email: data.email || '',
